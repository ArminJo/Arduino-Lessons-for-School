 ...
 */
void loop() {
    static bool sTimeoutDemoStarted = false;
     ...
     */
    if (! sTimeoutDemoStarted && (!BlueDisplay1.isConnectionEstablished()) && (millis() > TIMOUT_BEFORE_DEMO_MODE_STARTS_MILLIS)
