/*
 * Lessons with 2 buttons 2 LEDs and a speaker or piezo - Verknüpfung von Bedingungen
 * Solution
 *
 * Thema:
...
void loop() {
	 ...
	 */
	if (tRightButtonValue == LOW && tLeftButtonValue == LOW) {
		/*
		 * Both buttons pressed
		 */
		tone(PIN_SPEAKER, 2640);
	} else if (tRightButtonValue == HIGH && tLeftButtonValue == HIGH) {
		/*
		 * No button active
		 */
		noTone(PIN_SPEAKER);
	} else if (tRightButtonValue == LOW && tLeftButtonValue == HIGH) {
		/*
