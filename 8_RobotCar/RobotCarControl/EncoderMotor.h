...
//    virtual ~EncoderMotor();
    ...
    void stop(uint8_t aStopMode = DEFAULT_STOP_MODE); // resets State and TargetDistanceCount variables
     ...
     **********************************************************/
    /*
     * Reset() resets all members from CurrentMaxSpeed to (including) Debug to 0
     */
